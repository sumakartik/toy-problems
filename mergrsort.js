...
// Initial step: Input array is split into "sorted" sublists[4, 7, 4, 3, 9, 1, 2] -> [[4], [7], [4], [3], [9], [1], [2]]
// Merge step: Adjacent sublists are merged into sorted sublists[[4], [7], [4], [3], [9], [1], [2]] -> [[4, 7], [3, 4], [1, 9], [2]]
// Repeat merge step: [[4, 7], [3, 4], [1, 9], [2]] -> [[3, 4, 4, 7], [1, 2, 9]]
// Repeat merge step: [[3, 4, 4, 7], [1, 2, 9]] -> [[1, 2, 3, 4, 4, 7, 9]]
// Done! Return the sorted array: [1, 2, 3, 4, 4, 7, 9]
// Illustration of a recursive approach:
// Split the input array in half[4, 7, 4, 3, 9, 1, 2] -> [4, 7, 4], [3, 9, 1, 2]
// Both sides are sorted recursively:
// [4, 7, 4] -> [4, 4, 7]
// [3, 9, 1, 2] -> [1, 2, 3, 9]
// Both halves are merged: [4, 7, 4], [3, 9, 1, 2] -> [1, 2, 3, 4, 4, 7, 9]
...
// Split the input array in half[4, 7, 4] -> [4], [7, 4]
// Both sides are sorted recursively:
// [4] -> [4]
// [7, 4] -> [4, 7]
// Both halves are merged: [4], [4, 7] -> [4, 4, 7]
// I cheated again by going directly from[7, 4] to[4, 7], but that's really just:
// Split the input array in half[7, 4] -> [7], [4]
// Both sides are sorted recursively:
// [7] -> [7]
// [4] -> [4]
// Both halves are merged: [7], [4] -> [4, 7]
...
//     The merge step can be implemented using what is conceptually an insertion sort, and yet its time complexity is(spoiler alert!) much lower.Why is that ?
//         Extra credit:
...
var mergeSort = function (array, 1, m, r) {
    var n1 = m - l + 1;
    var n2 = r - m;
